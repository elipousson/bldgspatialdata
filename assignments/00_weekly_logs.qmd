...
2.  Locate the template file (`2022-MM-DD.md`) using the files pane of RStudio (you can [customize the pane layout](https://support.rstudio.com/hc/en-us/articles/200549016-Customizing-the-RStudio-IDE#pane-layout) using the options dialog for the RStudio IDE).
3.  Select the template file, make a copy, and rename the file substituting the month and date of the related session for `MM-DD` in the file name.
4.  Add your own reflection and questions to the new Markdown document. Make sure to keep the headings from the template in place. Use the [RStudio visual editor](https://rstudio.github.io/visual-markdown-editing/) to add formatting and links as needed.
