...
-   **How do you create inline code within a RMarkdown document? And what is online code useful for?** Use backticks (\`r \# inline code goes here\`) to create inline code within a R Markdown or Quarto document. This approach is handy for integrating variables into the text of a rendered document. Check out [The R Markdown Cookbook](https://bookdown.org/yihui/rmarkdown-cookbook/r-code.html) for more inline code and code chunks.
